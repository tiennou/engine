...
(function () {
    ...
    function makeGameObject({ runtimeData, intents, memory, getUsedCpu, globals, sandboxedFunctionWrapper, getHeapStatistics, cpuHalt }) {
        ...
        if (runtimeData.customObjectPrototypes) {
            runtimeData.customObjectPrototypes.forEach(i => {
                ...
                customObjectsInfo[i.objectType] = {
                    name: i.name,
                    make: customPrototypes(i.name, i.opts.parent, i.opts.properties, i.opts.prototypeExtender, !!i.opts.userOwned),
        ...
        var register = {
            ...
            rooms: {},
            roomEventLogCache: {},
            wrapFn: sandboxedFunctionWrapper || function (fn) {
                return fn;
            }
        };
    ...
    (function () {
        ...
        exports.init = function (_globals, _codeModules, _runtimeData, _intents, _memory, _fakeConsole, _consoleCommands, _timeout, _getUsedCpu, _scriptCachedData, _sandboxedFunctionWrapper, _getHeapStatistics, _cpuHalt) {
            ...
            if (!runCodeCache[userId].globals.require || runCodeCache[userId].runtimeData.userCodeTimestamp != runCodeCache[userId].globals.require.timestamp || !_.isObject(runCodeCache[userId].globals.require.cache.main) || !_.isFunction(runCodeCache[userId].globals.require.cache.main.loop)) {
...
//# sourceMappingURL=../sourcemaps/game/game.js.map
