...
module.exports = function (object, intent, scope) {
    ...
    var targets = _.filter(roomObjects, i => {
        return (!_.isUndefined(i.user) || i.type == 'powerBank') && i.user != object.user && i.x >= object.x - 3 && i.x <= object.x + 3 && i.y >= object.y - 3 && i.y <= object.y + 3;
    });
    ...
    for (var i in targets) {
        ...
        require('../_damage')(object, target, targetAttackPower, C.EVENT_ATTACK_TYPE_RANGED_MASS, scope);
    }

    object.actionLog.rangedMassAttack = {};
};
//# sourceMappingURL=../../../sourcemaps/processor/intents/creeps/rangedMassAttack.js.map
