...
module.exports = function (object, intent, { roomObjects, bulk, bulkUsers, stats, gameTime, eventLog, users }) {
    ...
    if (target.level < 8) {
        ...
        if (target.progress + boostedEffect >= nextLevelProgress && target.downgradeTime + C.CONTROLLER_DOWNGRADE_RESTORE >= gameTime + C.CONTROLLER_DOWNGRADE[target.level]) {
...
//# sourceMappingURL=../../../sourcemaps/processor/intents/creeps/upgradeController.js.map
