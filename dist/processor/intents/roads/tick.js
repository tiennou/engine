...
module.exports = function (object, { roomObjects, roomTerrain, bulk, gameTime }) {
    ...
    if (!object.nextDecayTime || gameTime >= object.nextDecayTime - 1) {
        ...
        if (_.any(roomObjects, i => i.x == object.x && i.y == object.y && i.type == 'swamp') || utils.checkTerrain(roomTerrain, object.x, object.y, C.TERRAIN_MASK_SWAMP)) {
            decayAmount *= C.CONSTRUCTION_COST_ROAD_SWAMP_RATIO;
        }
        if (_.any(roomObjects, i => i.x == object.x && i.y == object.y && i.type == 'wall') || utils.checkTerrain(roomTerrain, object.x, object.y, C.TERRAIN_MASK_WALL)) {
...
//# sourceMappingURL=../../../sourcemaps/processor/intents/roads/tick.js.map
