...
module.exports = function (object, { bulk, roomController }) {
    ...
    if (roomController) {
        ...
        if (!object.storeCapacityResource || !object.storeCapacityResource.energy || storeCapacity != object.storeCapacityResource.energy) {
            bulk.update(object, { storeCapacityResource: { energy: storeCapacity } });
        }
    }
};
//# sourceMappingURL=../../../sourcemaps/processor/intents/extensions/tick.js.map
