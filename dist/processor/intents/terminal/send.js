...
module.exports = function (object, intent, { bulk, gameTime }) {
    ...
    if (intent.resourceType != C.RESOURCE_ENERGY && object.store.energy < cost || intent.resourceType == C.RESOURCE_ENERGY && object.store.energy < intent.amount + cost) {
        return;
    }

    bulk.update(object, { send: intent });
};
//# sourceMappingURL=../../../sourcemaps/processor/intents/terminal/send.js.map
