...
module.exports = function (object, { bulk, bulkUsers, gameTime, roomInfo, users }) {
    ...
    if (object._upgraded && !(object.upgradeBlocked > gameTime)) {
        bulk.update(object, { downgradeTime: Math.min(object.downgradeTime + C.CONTROLLER_DOWNGRADE_RESTORE + 1, gameTime + C.CONTROLLER_DOWNGRADE[object.level] + 1) });
        return;
    }
...
//# sourceMappingURL=../../../sourcemaps/processor/intents/controllers/tick.js.map
